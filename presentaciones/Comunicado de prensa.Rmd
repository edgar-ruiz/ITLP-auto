...
library(stringr)
library(tidyverse)
load("Comunicado de prensa\\datos_final.RData")
...
## CONEVAL PRESENTA INFORMACIÓN REFERENTE AL ÍNDICE DE TENDENCIA LABORAL DE LA POBREZA AL `r ult.trim.l` de trimestre 20`r ult.anio`
...
En ese periodo, la Línea de Pobreza Extrema por Ingresos (costo de la canasta alimentaria) mostró en zonas rurales un aumento mayor al observado en el trimestre pasado (2.2% comparado con 2.1%
del trimestre anterior), mientras que el incremento fue menor en las zonas urbanas (1.5% comparado con 2.2% en el trimestre anterior). (Análisis LPI) 
...
###Variación trimestral del ITLP del tercer trimestre de 2018 
